...
class StockPrecio
{
    ...
    {   
        $sql = "SELECT A.COD_ARTICU, D.DESCRIPCIO, CAST(A.CANT_STOCK AS INT) AS CANT_STOCK, C.PRECIO, E.DESC_VALOR COLOR, CAST((C.PRECIO/(1+(F.PORCENTAJE/100))) AS DECIMAL(10,2)) PRECIO_S_IVA 
                FROM STA19 A
				...
				LEFT JOIN GVA41 F ON D.ID_GVA41_COD_IVA = F.ID_GVA41
