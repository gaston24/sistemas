...
if(!isset($_SESSION['username'])){
	...
	header("Location:../index.php");
		...
		<div class="mt-2 text-center fixed fixed-bottom bg-white" style="height: 30px!important; background-color: white;" id="pantalla">
			...
			<?php $typeInput = $suc>100 ? 'text' : 'hidden'; ?>
			
				<a <?=$typeInput?>> <strong>Importe total:</strong> </a> <input name="total_precio" size="3" id="totalPrecio" value="0" type="<?=$typeInput?>" onChange="verificarCredito()">
