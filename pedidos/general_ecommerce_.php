...
if(!isset($_SESSION['username'])){
	...
	if($_SESSION['nuevoPedido']==0 && $_SESSION['cargaPedido']==1){
		...
		$sql="
		EXEC SJ_SP_PEDIDOS_ECOMMERCE_VER '$dep', '$codClient'
		";
		...
		while($v=odbc_fetch_array($result)){
			...
			<td style="width: 5%" id="cant"><input type="text" name="cantPed[]" value="<?php echo '0'//(int)($v['CANT_SUG']) ;?>" size="4" tabindex="1" id="articulo" class="form-control form-control-sm" onkeyup="total();verifica()"></td>
