...
class Remito{
    ...
    public function traerRemito($nComp){
        ...
        ISNULL(G.CARD_FIRST_DIGITS+'-'+G.CARD_LAST_DIGITS, '') TARJETA , G.ISSUER BANCO, I.N_CUIT, 
		...
		LEFT JOIN GC_ECOMMERCE_PEDIDO F ON C.ID_NEXO_PEDIDOS_ORDEN = F.ID_GC_ECOMMERCE_ORDER
        LEFT JOIN GC_ECOMMERCE_PAYMENT_DETAIL G ON F.ID_GC_ECOMMERCE_ORDER = G.ID_GC_ECOMMERCE_ORDER 
