...
if(isset($_GET['comprobante'])){
	...
	$sql=
		...
		LEFT JOIN GC_ECOMMERCE_PEDIDO P ON A.ORDER_ID_TIENDA = P.ORDER_ID_PEDIDO COLLATE Latin1_General_BIN
		LEFT JOIN GC_ECOMMERCE_ORDER H ON P.ID_GC_ECOMMERCE_ORDER = H.ID_GC_ECOMMERCE_ORDER
		LEFT JOIN GC_ECOMMERCE_PAYMENT_PEDIDO PP ON P.ID_GC_ECOMMERCE_PEDIDO = PP.ID_GC_ECOMMERCE_PEDIDO
		LEFT JOIN GC_ECOMMERCE_PAYMENT_DETAIL I ON PP.ID_GC_ECOMMERCE_PAYMENT_DETAIL = I.ID_GC_ECOMMERCE_PAYMENT_DETAIL
