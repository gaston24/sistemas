...
$sql=
	...
	ISNULL(REPLACE(G.NOMBRE_SUC, 'RT - SUC - ', ''), C.CA_1111_SELECCIONABLE_PARA_TIPO_STOCK) ORIGEN, C.CA_1111_METODO_ENTREGA TIPO_ENVIO,  
	...
	INNER JOIN GVA24 C ON A.COD_TRANSP = C.COD_TRANSP
	...
	LEFT JOIN SUCURSAL L ON H.ID_DIRECCION_SUCURSAL_ENTREGA = L.CA_423_ID_DIRECCION_SUCURSAL_ENTREGA_VTEX
