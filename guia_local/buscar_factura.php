...
$sql=
	...
	LEFT JOIN GC_ECOMMERCE_PEDIDO M ON A.NRO_PEDIDO = M.NUMERO_PEDIDO_TANGO
	LEFT JOIN SUCURSAL J ON M.ID_DIRECCION_SUCURSAL_ENTREGA = J.CA_423_ID_DIRECCION_SUCURSAL_ENTREGA_VTEX
