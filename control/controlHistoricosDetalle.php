...
<div class="row">
	...
	<div class="col-2">
	<div style="margin-left: 1rem;"><button class="btn btn-success btn_exportar" id="btnExport" onclick="exportar('<?= $numRem ?>')"><i class="fa fa-file-excel-o"></i> Exportar<i class="bi bi-file-earmark-excel"></i></button></div>
	</div>
</div>
...
<script>
	...
	const exportar = (numRem) => {
		...
		$("table").table2excel({
			...
			exclude: ".noExl",
			name: "Worksheet Name",
			filename: `Detalle - ${numRem}`, //do not include extension
