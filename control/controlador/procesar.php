...
$sql="
		...
		INNER JOIN [LAKERBIS].LOCALES_LAKERS.DBO.CTA11 B ON A.NCOMP_IN_S = B.NCOMP_IN_S AND A.TCOMP_IN_S = B.TCOMP_IN_S AND A.NRO_SUCURS = B.NRO_SUCURS AND A.FECHA_MOV = B.FECHA_MOV
		WHERE PROMOCION != 1
		AND T_COMP = 'REM' 
		AND N_COMP = '$rem'
";
