...
if(substr($v['DESCRIPCIO'], -11)=='-- SALE! --'){
    ...
    <td style="width: 3%"><?= (int)($v['CANT_STOCK']) ;?>  </td>
    ...
    <td style="width: 4%"><input type="text" name="cantPed_812[]" value="0" onkeyup="total();precioTotal()" size="1" tabindex="1"  class="form-control form-control-sm">  </td>
    <td style="width: 2% ; border-left: 1px solid black"><?= (int)($v['813_STOCK']) ;?>  </td>				
    <td style="width: 2%"><?= (int)($v['813_VENDIDO']) ;?>  </td>
    <td style="width: 4%"><input type="text" name="cantPed_813[]" value="0" onkeyup="total();precioTotal()" size="1" tabindex="1"  class="form-control form-control-sm">  </td>
    <td style="width: 2% ; border-left: 1px solid black"><?= (int)($v['814_STOCK']) ;?>  </td>
    <td style="width: 2%"><?= (int)($v['814_VENDIDO']) ;?>  </td>
    <td style="width: 4%"><input type="text" name="cantPed_814[]" value="0" onkeyup="total();precioTotal()" size="1" tabindex="1"  class="form-control form-control-sm">  </td>
    <td style="width: 2% ; border-left: 1px solid black"><?= (int)($v['815_STOCK']) ;?>  </td>
    <td style="width: 2%"><?= (int)($v['815_VENDIDO']) ;?>  </td>
    <td style="width: 4%"><input type="text" name="cantPed_815[]" value="0" onkeyup="total();precioTotal()" size="1" tabindex="1"  class="form-control form-control-sm">  </td>
    <td style="width: 2% ; border-left: 1px solid black"><?= (int)($v['816_STOCK']) ;?>  </td>				
    <td style="width: 2%"><?= (int)($v['816_VENDIDO']) ;?>  </td>
    <td style="width: 4%"><input type="text" name="cantPed_816[]" value="0" onkeyup="total();precioTotal()" size="1" tabindex="1"  class="form-control form-control-sm">  </td>
    <td style="width: 2% ; border-left: 1px solid black"><?= (int)($v['876_STOCK']) ;?>  </td>				
    <td style="width: 2%"><?= (int)($v['876_VENDIDO']) ;?>  </td>
    <td style="width: 4%"><input type="text" name="cantPed_876[]" value="0" onkeyup="total();precioTotal()" size="1" tabindex="1"  class="form-control form-control-sm">  </td>
