   ...
   <div class="table-responsive">
        <table class="table table-hover table-condensed table-striped text-center ml-4" id="tableOrden">
            ...
            ?>
                ...
                <tr>
                <td><a target="_blank" data-toggle="modal" data-target="#exampleModal<?= substr($key['COD_ARTICU'], 0, 13); ?>" href="../../../Imagenes/<?= $key['COD_ARTICU']; ?>.jpg"><img src="../../../Imagenes/<?= $key['COD_ARTICU'] ?>.jpg" alt="Sin imagen" height="50" width="50"></a></td>
