...
$orden = new Orden();
$todasLasOrdenes = $orden->traerOrdenesActivasTodas();
...
<head>
    ...
    <title>Desactivar ordenes</title>
</head>
<body>

    <h3 class="mb-4 mt-4 ml-3"><i class="fa fa-archive"></i>  Desactivar Ordenes</h3>
    ...
    <div class="form-row ml-3 mb-3 contenedor">
            ...
            <div class="btn-group" role="group" aria-label="Basic example">
                ...
                <div>
                    <button type="button" class="btn btn-danger" id="btn_desac" onclick="desactivaOrdenes()">Desactivar
