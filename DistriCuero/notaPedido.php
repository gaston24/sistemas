        ...
        <div class="table-responsive">
            <table class="table text-center ml-4" id="tablePed">
                ...
                ?>
                    ...
                    <tr>
                    <td><a target="_blank" data-toggle="modal" data-target="#exampleModal<?= $key['COD_ARTICU']?>" href="../../../Imagenes/<?= $key['COD_ARTICU'] ?>.jpg"><img src="../../../Imagenes/<?= $key['COD_ARTICU'] ?>.jpg" alt="Sin imagen" height="50" width="50"></a></td>
