...
class Articulo
{
    ...
    {
        $sql = "SELECT A.COD_ARTICU, A.DESCRIPCION, A.DESTINO, A.TEMPORADA, B.RUBRO, A.FECHA_MOD, A.LIQUIDACION, C.PRECIO, CAST((C.PRECIO/(1+(E.PORCENTAJE/100))) AS DECIMAL(10,2)) PRECIO_S_IVA
