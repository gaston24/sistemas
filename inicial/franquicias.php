...
WHERE CENTRAL = 1 
AND A.COD_ARTICU COLLATE Latin1_General_BIN NOT IN (SELECT COD_ARTICU FROM SOF_DISTRIBUCION_INICIAL_RELACION WHERE COD_CLIENT = '$codClient')
...
<h2 align="center">Franquicias Sin Pedidos</h2></br>
...
<table class="table table-striped">
        ...
        <tr ><!--style="font-size:smaller">-->
				...
				<td><a href="inicFranquicias.php?codArt=<?php echo $v['COD_ARTICU'] ;?>&contenedor=<?php echo $v['CONTENEDOR'] ;?>"><?php echo $v['COD_ARTICU'] ;?></a></td>
