...
<h2 align="center">Articulos Disponibles Para Locales Propios</h2></br>
...
<table class="table table-striped">
        ...
        <tr ><!--style="font-size:smaller">-->
				...
				<td><a href="inicLocales.php?codArt=<?php echo $v['COD_ARTICU'] ;?>&contenedor=<?php echo $v['CONTENEDOR'] ;?>"><?php echo $v['COD_ARTICU'] ;?></a></td>
