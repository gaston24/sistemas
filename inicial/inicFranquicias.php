...
WHERE 
((NRO_SUCURS IN 
(SELECT NRO_SUCURS FROM 
SOF_USUARIOS A
INNER JOIN SUCURSAL B
ON A.NRO_SUCURS = B.NRO_SUCURSAL
WHERE A.NRO_SUCURS > 104
AND B.CA_423_HABILITADO = 1
))OR COD_CLIENT IN ('GTWEB', 'GTDAF', 'GTFOT'))
...
<table class="table table-striped" id="id_tabla">
        ...
        <tr ><!--style="font-size:smaller">-->
				...
				<td><input type="text" value="1" name="cantPed[]" size="5"  id="articulo" onChange="total();verifica()"></td>
