	...
	header("Location:../../login.php");
		...
		<thead>
			...
			<tr >
				...
				<th ><small>TERRAZAS<br>Stock</small></th>				
				<th ><small>Venta</small></th>				
				<th ><small>BALLESTER<br>Stock</small></th>				
				<th ><small>Venta</small></th>				
				<th ><small>SAN MIGUEL<br>Stock</small></th>		
				<th ><small>Venta</small></th>								
		...
		?>
			...
			<td style="border-left: 1px solid black"><?php echo (int)($v['833_STOCK']) ;?>  </td>
			<td ><?php echo (int)($v['833_VENDIDO']) ;?>  </td>

			<td style="border-left: 1px solid black"><?php echo (int)($v['903_STOCK']) ;?>  </td>				
			<td ><?php echo (int)($v['903_VENDIDO']) ;?>  </td>

			<td style="border-left: 1px solid black"><?php echo (int)($v['851_STOCK']) ;?>  </td>				
			<td ><?php echo (int)($v['851_VENDIDO']) ;?>  </td>
