...
<h1 align="center">Bienvenido a Industrias Levi</h1>
...
<ul class="nav justify-content-center">
	<div class="btn-group" role="group" aria-label="Basic example">
		...
		<button type="button" class="btn btn-secondary" onclick="location.href='otros/eligeTraza.php'">Trazabilidad</button>
	</div>
</ul>
</br>
