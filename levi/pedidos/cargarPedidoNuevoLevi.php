...
//no se ejecuta la funcion backup
//backup();
...
switch($locales[$i])
{
case 'FRBALL': $suc = 903; break;
case 'FRMAL2': $suc = 833; break;
case 'FRSMI2': $suc = 851; break;
}
...
switch($locales[$i])
{
case 'FRBALL': $total_ped = array_sum($_POST['cantPed_903']); break;
case 'FRMAL2': $total_ped = array_sum($_POST['cantPed_833']); break;
case 'FRSMI2': $total_ped = array_sum($_POST['cantPed_851']); break;
...
switch($locales[$i])
{
case 'FRBALL': $cant_local = $_POST['cantPed_903']; break;
case 'FRMAL2': $cant_local = $_POST['cantPed_833']; break;
case 'FRSMI2': $cant_local = $_POST['cantPed_851']; break;
