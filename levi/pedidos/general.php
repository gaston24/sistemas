...
if(!isset($_SESSION['username'])){
	...
	header("Location:../../login.php");
		...
		SELECT * FROM 
			...
			CASE WHEN A.[902_STOCK] IS NULL THEN 0 ELSE A.[902_STOCK] END [902_STOCK], 
			CASE WHEN A.[902_VENDIDO] IS NULL THEN 0 ELSE A.[902_VENDIDO] END [902_VENDIDO], 
			...
			(	
				...
				B.RUBRO, CAST(CANT_STOCK AS INT)CANT_STOCK, A.[851_STOCK], A.[851_VENDIDO], A.[833_STOCK], A.[833_VENDIDO], A.[902_STOCK], A.[902_VENDIDO], 	
				...
				(
					...
					(
						...
						A.[851_STOCK], A.[851_VENDIDO], A.[833_STOCK], A.[833_VENDIDO], A.[902_STOCK], A.[902_VENDIDO]
						FROM
						(
							SELECT A.COD_ARTICU, A.DESCRIPCIO, CAST(A.CANT_STOCK AS INT) CANT_STOCK, B.[851_STOCK], B.[851_VENDIDO], B.[833_STOCK], B.[833_VENDIDO], B.[902_STOCK], B.[902_VENDIDO]
							FROM
