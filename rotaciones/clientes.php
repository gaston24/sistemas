...
$sql="
SELECT COD_CLIENT, DESCRIPCION FROM SOF_USUARIOS WHERE COD_CLIENT LIKE '[GF][TR]%' AND NRO_SUCURS
IN
(SELECT NRO_SUCURSAL FROM SUCURSAL WHERE CA_423_HABILITADO_M = 1
AND NRO_SUCURSAL NOT IN (1, 99))
ORDER BY NRO_SUCURS
";
...
<table class="table table-striped" id="id_tabla">
        ...
        <tr ><!--style="font-size:smaller">-->
				...
				<td><a href="pedidos.php?cliente=<?php echo $v['COD_CLIENT'] ;?>"><?php echo $v['DESCRIPCION'] ;?></td>
