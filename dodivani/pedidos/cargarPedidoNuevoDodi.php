...
switch($locales[$i])
{
case 'FRCAB': $suc = 910; break;
case 'FRREMP': $suc = 900; break;
case 'FRSICT': $suc = 849; break;
}
...
switch($locales[$i])
{
case 'FRCAB': $total_ped = array_sum($_POST['cantPed_910']); break;
case 'FRREMP': $total_ped = array_sum($_POST['cantPed_900']); break;
case 'FRSICT': $total_ped = array_sum($_POST['cantPed_849']); break;
...
switch($locales[$i])
{
case 'FRCAB': $cant_local = $_POST['cantPed_910']; break;
case 'FRREMP': $cant_local = $_POST['cantPed_900']; break;
case 'FRSICT': $cant_local = $_POST['cantPed_849']; break;
