...
if(!isset($_SESSION['username'])){
	...
	header("Location:../../login.php");
		...
		?>
			...
			<td style="border-left: 1px solid black"><?php echo (int)($v['849_STOCK']) ;?>  </td>
			<td ><?php echo (int)($v['849_VENDIDO']) ;?>  </td>

			<td style="border-left: 1px solid black"><?php echo (int)($v['900_STOCK']) ;?>  </td>				
			<td ><?php echo (int)($v['900_VENDIDO']) ;?>  </td>

			<td style="border-left: 1px solid black"><?php echo (int)($v['910_STOCK']) ;?>  </td>				
			<td ><?php echo (int)($v['910_VENDIDO']) ;?>  </td>
