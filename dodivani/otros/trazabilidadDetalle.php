...
SELECT CAST(A.FECHA_MOV AS date)FECHA_MOV, A.N_COMP, A.NCOMP_IN_S, A.NCOMP_ORIG, A.LEYENDA1, A.T_COMP, A.TALONARIO, A.TCOMP_IN_S, 
CAST(CASE TIPO_MOV WHEN 'S' THEN -B.CANTIDAD ELSE B.CANTIDAD END AS int)CANTIDAD
FROM STA14 A
INNER JOIN STA20 B
...
?>
		...
		<tr>
			...
			<td width="9%"><?php echo $v['LEYENDA1']?></td>
