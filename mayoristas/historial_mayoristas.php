...
$sql=
	...
	SELECT C.RAZON_SOCI, CAST(FECHA_PEDI AS DATE)FECHA, A.NRO_PEDIDO, LEYENDA_1, B.CANT FROM GVA21 A
	INNER JOIN
	(
	SELECT NRO_PEDIDO, CAST(SUM(CANT_PEDID) AS FLOAT) CANT FROM GVA03 --WHERE TALON_PED IN (96, 97) 
	GROUP BY NRO_PEDIDO
	)B
...
<table class="table table-striped" style="margin-left:20px; margin-right:50px">
        ...
        <tr >
                ...
                <td class="col-"><?php echo $v['RAZON_SOCI'] ;?></td>
