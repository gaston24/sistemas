...
if(substr($v['DESCRIPCIO'], -11)=='-- SALE! --'){
    ...
    <a target="_blank" href="../../../Imagenes/<?= substr($v['COD_ARTICU'], 0, 13) ;?>.jpg"><img src="../../../Imagenes/<?= substr($v['COD_ARTICU'], 0, 13) ;?>.jpg" alt="" height="40" width="40"></a>
        ...
        <td style="width: 4%"><input type="text" name="cantPed_812[]" id="cantPed" value="0" onkeyup="total();precioTotal()" size="1" tabindex="1"  class="form-control form-control-sm">  </td>
        <td style="width: 2% ; border-left: 1px solid black"><?= (int)($v['813_STOCK']) ;?>  </td>				
        <td style="width: 2%"><?= (int)($v['813_VENDIDO']) ;?>  </td>
        <td style="width: 4%"><input type="text" name="cantPed_813[]" id="cantPed" value="0" onkeyup="total();precioTotal()" size="1" tabindex="1"  class="form-control form-control-sm">  </td>
        <td style="width: 2% ; border-left: 1px solid black"><?= (int)($v['814_STOCK']) ;?>  </td>
        <td style="width: 2%"><?= (int)($v['814_VENDIDO']) ;?>  </td>
        <td style="width: 4%"><input type="text" name="cantPed_814[]" id="cantPed" value="0" onkeyup="total();precioTotal()" size="1" tabindex="1"  class="form-control form-control-sm">  </td>
        <td style="width: 2% ; border-left: 1px solid black"><?= (int)($v['815_STOCK']) ;?>  </td>
        <td style="width: 2%"><?= (int)($v['815_VENDIDO']) ;?>  </td>
        <td style="width: 4%"><input type="text" name="cantPed_815[]" id="cantPed" value="0" onkeyup="total();precioTotal()" size="1" tabindex="1"  class="form-control form-control-sm">  </td>
        <td style="width: 2% ; border-left: 1px solid black"><?= (int)($v['816_STOCK']) ;?>  </td>				
        <td style="width: 2%"><?= (int)($v['816_VENDIDO']) ;?>  </td>
        <td style="width: 4%"><input type="text" name="cantPed_816[]" id="cantPed" value="0" onkeyup="total();precioTotal()" size="1" tabindex="1"  class="form-control form-control-sm">  </td>
        <td style="width: 2% ; border-left: 1px solid black"><?= (int)($v['876_STOCK']) ;?>  </td>				
        <td style="width: 2%"><?= (int)($v['876_VENDIDO']) ;?>  </td>
        <td style="width: 4%"><input type="text" name="cantPed_876[]" id="cantPed" value="0" onkeyup="total();precioTotal()" size="1" tabindex="1"  class="form-control form-control-sm">  </td>
