...
switch($locales[$i])
{
case 'FRBAUD': $total_ped = array_sum($_POST['cantPed_812']); break;
case 'FRORCE': $total_ped = array_sum($_POST['cantPed_813']); break;
case 'FRORIG': $total_ped = array_sum($_POST['cantPed_814']); break;
...
switch($locales[$i])
{
case 'FRBAUD': $cant_local = $_POST['cantPed_812']; break;
case 'FRORCE': $cant_local = $_POST['cantPed_813']; break;
case 'FRORIG': $cant_local = $_POST['cantPed_814']; break;
